...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link rel="shortcut icon" href="https://simpeg.wonosobokab.go.id/e_kp/upload/wonosobo.png">
...
<!--			<li><a href="<?php echo base_url(); ?>admin"><i class="icon-home icon-white"> </i> Beranda</a></li>
		  ...
		  <li class="dropdown">
			...
			<li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-random icon-white"> </i> &nbsp;Usulan KP<span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/kp"><i class="icon-file icon-red"></i> Usulan KP</a></li>
			...
			<li class="dropdown">
              ...
              <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/manage_admin"><i class="icon-user icon-red"></i>&nbsp;&nbsp;Manajemen Admin</a></li>
				...
				<li class="dropdown-header"><h5>BackUp</h5></li>
			 	<li><a tabindex="-1" href="<?php echo base_url(); ?>admin/agenda_kp2"><i class="icon-barcode icon-red"></i> Kenaikan Pangkat</a></li>
...
<br><br>
	  ...
	  <div class="span12 well well-sm">
		<h5 style="font-weight: bold">BKD KABUPATEN WONOSOBO<a href="http://bkd.wonosobokab.go.id" target="_blank"> </a></h5>
		<h6>&copy;  2022</h6>
	  </div>
