...
<div class="navbar navbar-inverse"style="background-color:#3CB371;">
	...
	?>
	<form action="<?=base_URL()?>admin/pensiun/add" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">	
		...
		<tr><td width="30%">golpens</td><td><select name="jenpens" class="form-control" style="width: 150px" required><option value="<?php echo $golpens;?>"> - Golongan Pensiun - </option>
			<?php
